    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-zinc-400 mt-1">
          Begin the migration analysis by uploading your Oracle SQL file. For live database connections, use the <strong className="text-zinc-300">Live Database</strong> option in the sidebar.
        </p>
      </div>
